...
export function WebsiteStructuredData({
  ...
  useEffect(() => {
    ...
    let script = document.querySelector<HTMLScriptElement>(
      'script[type="application/ld+json"][data-type="website"]'
    );
    if (script) {
...
export function OrganizationStructuredData({
  ...
  useEffect(() => {
    ...
    let script = document.querySelector<HTMLScriptElement>(
      'script[type="application/ld+json"][data-type="organization"]'
    );
    if (script) {
      script.textContent = JSON.stringify(structuredData);
    } else {
...
export function ArticleStructuredData({
  ...
  useEffect(() => {
    ...
    let script = document.querySelector<HTMLScriptElement>(
      'script[type="application/ld+json"][data-type="article"]'
    );
    if (script) {
      script.textContent = JSON.stringify(structuredData);
    } else {
...
export function LocalBusinessStructuredData({
  ...
  useEffect(() => {
    ...
    let script = document.querySelector<HTMLScriptElement>(
      'script[type="application/ld+json"][data-type="localbusiness"]'
    );
    if (script) {
      script.textContent = JSON.stringify(structuredData);
    } else {
