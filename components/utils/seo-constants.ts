...
export const SEO_CONFIG = {
  ...
  defaultDescription: "Discover AI-powered tools for email enhancement, travel planning, and news curation. Boost your productivity with intelligent solutions.",
...
export const PAGE_SEO = {
  home: {
    ...
    description: "Discover AI-powered tools for email enhancement, travel planning, and news curation. Boost your productivity with intelligent solutions.",
    keywords: [...SEO_CONFIG.keywords, "home", "dashboard"],
    ogTitle: "Everyday AI - AI-Powered Tools for Everyday Productivity",
    ogDescription: "Discover AI-powered tools for email enhancement, travel planning, and news curation. Boost your productivity with intelligent solutions.",
    twitterTitle: "Everyday AI - AI-Powered Tools for Everyday Productivity",
    twitterDescription: "Discover AI-powered tools for email enhancement, travel planning, and news curation. Boost your productivity with intelligent solutions."
  },
  ...
  smartEmail: {
    ...
    keywords: [...SEO_CONFIG.keywords, "smart email", "email enhancement", "tone analysis", "professional email"],
    ogTitle: "Smart Email Tool - AI-Powered Email Enhancement",
    ogDescription: "Transform your emails with AI-powered suggestions for tone, clarity, and professionalism. Perfect for business communication and personal correspondence.",
    twitterTitle: "Smart Email Tool - AI-Powered Email Enhancement",
    twitterDescription: "Transform your emails with AI-powered suggestions for tone, clarity, and professionalism. Perfect for business communication and personal correspondence."
  },
  ...
  travelItinerary: {
    ...
    keywords: [...SEO_CONFIG.keywords, "travel itinerary", "trip planning", "travel planning", "budget optimization"],
    ogTitle: "Travel Itinerary Builder - AI-Powered Trip Planning",
    ogDescription: "Create personalized travel plans with AI recommendations for destinations, activities, and budget optimization. Your perfect trip, crafted intelligently.",
    twitterTitle: "Travel Itinerary Builder - AI-Powered Trip Planning",
    twitterDescription: "Create personalized travel plans with AI recommendations for destinations, activities, and budget optimization. Your perfect trip, crafted intelligently."
  },
  ...
  newsDigest: {
    ...
    keywords: [...SEO_CONFIG.keywords, "news digest", "news curation", "AI news", "personalized news"],
    ogTitle: "News Digest - AI-Curated News Summaries",
    ogDescription: "Stay informed with AI-curated news summaries tailored to your interests. Get the most relevant stories without the noise.",
    twitterTitle: "News Digest - AI-Curated News Summaries",
    twitterDescription: "Stay informed with AI-curated news summaries tailored to your interests. Get the most relevant stories without the noise."
  }
}
