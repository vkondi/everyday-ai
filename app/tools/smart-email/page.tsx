...
export default function SmartEmailPage() {
  ...
  const featureCards = [
    ...
    },
    {
      ...
      description:
        'Improve sentence structure and eliminate ambiguity for crystal clear messaging.',
    },
    {
      icon: Shield,
      ...
      description:
        'Add professional polish with grammar corrections and industry-specific language.',
    },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-700 dark:text-slate-300 text-lg">
              Transform your emails with AI-powered suggestions for tone, clarity, and
              professionalism.
            </p>
          </div>
          ...
          <Card className="mb-8 border-amber-200 dark:border-amber-800">
            <CardHeader>
              ...
              <CardDescription>
                Paste your email content below. Our AI will analyze and enhance it for better
                communication.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                <p className="text-sm text-muted-foreground">{emailContent.length} characters</p>
                <Button
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          copyToClipboard(results.recommended_subject, setCopySubjectSuccess)
                        }
                      >
                        {copySubjectSuccess ? (
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      ...
                      <div className="bg-muted/30 rounded-lg p-3">
                        ...
                        <p className="text-sm font-medium capitalize">
                          {results.analysis.call_to_action}
                        </p>
                      </div>
                    </div>
                  </div>
