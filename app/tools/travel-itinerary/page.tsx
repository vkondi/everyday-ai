...
} from '@/components/utils/error-utils';
...
export default function TravelItineraryPage() {
  ...
  const featureCards = [
    {
      ...
      description:
        'Get personalized recommendations for attractions, restaurants, and activities based on your preferences and budget.',
    },
    {
      icon: DollarSign,
      ...
      description:
        'AI analyzes costs and suggests optimal spending allocation across accommodation, food, activities, and transportation.',
    },
    {
      icon: Calendar,
      ...
      description:
        'Smart scheduling considers weather, opening hours, and crowd levels to maximize your travel experience.',
    },
  ];
  ...
  const preferenceOptions = [
    ...
    { id: 'food', label: 'Food', description: 'Local cuisine, restaurants, food tours' },
    {
      id: 'adventure',
      label: 'Adventure',
      description: 'Outdoor activities, hiking, water sports',
    },
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Card className="mb-8 border-amber-200 dark:border-amber-800">
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium mb-3">Travel Preferences *</label>
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mt-1">
                      <Badge
                        variant="secondary"
                        className={
                          results.budget_status === 'within_budget'
                      ...
                      <span className="text-sm text-muted-foreground">
                        {results.daily_itinerary.length} days • {results.total_cost} total •{' '}
                        {results.daily_itinerary[0]?.date} to{' '}
                        {results.daily_itinerary[results.daily_itinerary.length - 1]?.date}
                      </span>
                    </div>
                  </div>
                </div>
                                    ...
                                    <div className="flex items-start space-x-4 p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
                                      ...
                                      <div className="flex-1">
                                        <div className="flex items-center space-x-2 mb-2">
                                          ...
                                          <Badge
                                            className={`text-xs font-medium ${getTypeColor(activity.type)}`}
                                          >
                                            {activity.type}
                                          </Badge>
                                        </div>
